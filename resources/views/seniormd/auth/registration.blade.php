...
<body class="account-page">
                  ...
                  <div class="col-12 col-md-6">
                     <div class="left">
                        <ul>
                           ...
                           <li><span><i class="fas fa-map-marker-alt"></i> Location : 22, South Wales, New York</span>
                           </li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <div class="right">
                        <ul>
                           ...
                           <li class="dropdown language-select">
                              <span class="dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown"
         ...
         <nav class="navbar navbar-expand-lg header-nav">
            ...
            <ul class="nav header-navbar-rht">
               <li class="nav-item">
                  ...
                  <a class="nav-link header-login" href="{{route('login.show.mdDocotr')}}">login </a>
            ...
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-12 text-center">
                     <a href="index-2.html" class="footer-logo logo">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-lg-12 text-center">
                        <div class="copyright-text">
                           <p class="mb-0">&copy; 2020 <a href=# class="text-yellow"> Dentalcare</a> All Rights
                              Reserved.</p>
                        </div>
                     </div>
                  </div>
   ...
   $('.registrationform').submit(function(e){
       ...
       $.ajax({
            url: "{{ route('registration.data.seniorMdDocotr') }}",
       type: "post",
            data: fd,
            dataType: "JSON",
            processData: false,
        ...
        //  $('.generalsets').prop('disabled', true);
         ...
         success: function (result) {
           ...
           if(result.status===true){
            ...
            window.location.href = "{{route('login.show.seniorMdDocotr')}}";
           }
           else{
            iziToast.error({
                           message: result.msg,
