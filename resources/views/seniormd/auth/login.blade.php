...
<body class="account-page">
         ...
         <nav class="navbar navbar-expand-lg header-nav">
            ...
            <ul class="nav header-navbar-rht">
               <li class="nav-item">
                  ...
                  <a class="nav-link header-login" href="{{route('login.show.mdDocotr')}}">Sign Up </a>
                        ...
                        <div class="col-md-12 col-lg-6 login-right">
                           ...
                           <form action="#" method="post" class="loginform">
                              ...
                              <div class="text-center dont-have">Don’t have an account? <a
                                    href="{{route('login.show.mdDocotr')}}">Register</a>
                              </div>
                           </form>
                        </div>
                     </div>
   ...
   $('.loginform').submit(function(e){
       ...
       $.ajax({
            url: "{{ route('login.data.seniorMdDocotr') }}",
       type: "post",
            data: fd,
            dataType: "JSON",
            processData: false,
        ...
        //  $('.generalsets').prop('disabled', true);
         ...
         success: function (result) {
           ...
           if(result.status===true){
            ...
            window.location.href = "{{route('seniorMdDocotr.dashboard')}}";
           }
           else{
            iziToast.error({
                           message: result.msg,
