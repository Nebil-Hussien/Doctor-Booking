...
< @endsection @section('content') <div class="col-md-7 col-lg-8 col-xl-9">
   <div class="row">
         ...
         <div class="profile-header">
            <div class="row align-items-center">
               ...
               <div class="col ml-md-n2 profile-user-info">
                  ...
                  <div class="user-Location"><i class="fe fe-map-marker" style="color:black"></i>{{$details->address}}</div>
                  <div class="about-text">{{$details->biography}}</div>
               </div>
            </div>
         </div>

         <div class="profile-menu pt-1">
            <ul class="nav nav-tabs nav-tabs-solid bg-white">
               <li class="nav-item">
                  <a class="nav-link active" data-bs-toggle="tab" href="#per_details_tab" id="personal">Personal Details</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="tab" href="#password_tab" id="eductiondoc">Education</a>
               </li>
               {{-- <li class="nav-item">
   ...
   <script>
      ...
      $(function() {
         ...
         $('#manage-user').dataTable({
            ...
            "ajax": {
               url: "{{ route('seniorMdDoctor.doctor.profile.eduction')}}",
               "type": "POST",
               "data": function(d) {
                  d._token = "{{ csrf_token() }}";
                  d.id = val;
         ...
         $('body').on('click', '.status_item', function() {
            ...
            $.ajax({
               type: 'POST',
               url: "{{ route('seniorMdDoctor.doctor.profile.eduction.status') }}",
               data: fd,
               cache: false,
               contentType: false,
               processData: false,
