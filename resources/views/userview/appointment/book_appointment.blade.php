                                               ...
                                               <div class="row form-row">
                                                   ...
                                                   <div class="col-12 col-sm-6">
                                                       <div class="form-group">
                                                           ...
                                                           <select class="form-select form-control" name="service_type"  id="service_type" required>
                                                               @foreach($serviceType as $Type){
                                                               <option value="{{ $Type->id }}">{{ $Type->service }}</option>
                                                               @endforeach
                                                           </select>
                                                           <input type="hidden" class="form-control" name="serviceDetail" id="serviceDetail" value="{{$serviceType}}}" required>
                                                       </div>
                                                   </div>
                                                   <div class="col-md-6">
                                                   ...
                                                   <div class="col-12 col-sm-6">
                                                       <div class="form-group">
                                                           <label>Price</label>
                                                           <input type="text" disabled class="form-control" name="price" id="price" value="" required>
                                                       </div>
                                                   </div>
                                                   <div class="col-12 col-sm-6">
                                                       <div class="form-group">
...
@section('exrtajs')
    <script>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.status === true) {
                        ...
                        let url = "{{ route('doctor.assignment.admin', ':id') }}";
                        url = url.replace(':id', result.appointment_id);
        ...
        $("#service_type").on('change', function(){
            var serviceId = document.getElementById("service_type").value;
            var serviceDetail = document.getElementById("serviceDetail").value;

            for (const i in serviceDetail) {
                document.getElementById("price").value = serviceDetail[3];
                /*if (serviceDetail[i].id == serviceId) {
