...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <a href="{{route('patient.profile.admin', $user_id)}}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a>
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="relation" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
...
<script>
    $(function() {
        ...
        $('.profileedit').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('patient.family.submit.admin') }}",
                type: "post",
                data: fd,
                dataType: "JSON",
                processData: false,
