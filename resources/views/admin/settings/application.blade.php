    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('site_title', 'Solmet')  }}" name="site_title" required id="site_title" placeholder="Site Name">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="agent_distance" class="col-xs-2 col-form-label">Agent Search Radius</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('agent_distance', '1')  }}" name="agent_distance" required id="agent_distance" placeholder="Agent Search Radius">
					</div>
				</div>

				<div class="form-group row">
					<label for="agent_pickup_commission" class="col-xs-2 col-form-label">Agent Pickup Commission</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('agent_pickup_commission', '1')  }}" name="agent_pickup_commission" required id="agent_pickup_commission" placeholder="Agent Pickup Commission">
					</div>
				</div>

				<div class="form-group row">
					<label for="agent_drop_commission" class="col-xs-2 col-form-label">Agent Drop Commission</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ Setting::get('agent_drop_commission', '1')  }}" name="agent_drop_commission" required id="agent_drop_commission" placeholder="Agent Drop Commission">
					</div>
				</div>
