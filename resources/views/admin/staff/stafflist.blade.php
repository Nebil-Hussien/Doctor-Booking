...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header d-flex justify-content-between">
            {{-- <div class="row"> --}}
                {{-- <div class="col-sm-12"> --}}
                    <h3 class="page-title d-inline">List Of Staff</h3>
                    <a href="#Add_service" data-bs-toggle="modal" class="btn btn-primary float-end mt-2">Add Staff</a>
                {{-- </div> --}}
            {{-- </div> --}}
        </div>
...
<script>
    $(function() {
        ...
        $('#manage_service').dataTable({
            ...
            "ajax": {
                url: "{{ route('admin.staff_ajax_list')}}",
                "type": "POST",
                "data": function(d) {
                    d._token = "{{ csrf_token() }}";
                },
