...
<div class="page-wrapper">
   <div class="content container-fluid">
      ...
      <div class="page-header">
         <div class="row">
            <div class="col-sm-12">
               <h3 class="page-title"> Approval List of Doctors</h3>
...
<script>
   $(function() {
      ...
      $('#manage-user').dataTable({
         ...
         "ajax": {
            url: "{{ route('approval.seniormddoctor.ajax.admin')}}",
            "type": "POST",
            "data": function(d) {
               d._token = "{{ csrf_token() }}";
            },
      ...
      $('body').on('click', '.status_item', function() {
         ...
         $.ajax({
            type: 'POST',
            url: "{{ route('approval.seniormddoctor.status.admin') }}",
            data: fd,
            cache: false,
            contentType: false,
            processData: false,
      ...
      $('body').on('click', '.delete_item', function() {
         ...
         $.ajax({
            type: 'POST',
            url: "{{ route('seniormddoctor.delete.admin') }}",
            data: fd,
            cache: false,
            contentType: false,
            processData: false,
