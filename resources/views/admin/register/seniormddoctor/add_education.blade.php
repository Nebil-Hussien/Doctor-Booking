...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <a href=" {{route('mddoctor.profile.admin', $doctor_id)}} " class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a>
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="field_study" value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Graduated From</label>
                                <input type="text" name="graduated_from" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Year of Completion</label>
                                <input type="number" class="form-control" name="year_completion" value="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
...
<script>
    $(function() {
        ...
        $('.profileedit').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('mddoctor.register.education.submit.admin') }}",
                type: "post",
                data: fd,
                dataType: "JSON",
                processData: false,
