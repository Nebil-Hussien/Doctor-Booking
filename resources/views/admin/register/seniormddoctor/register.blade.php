                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="middle_name" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control" name="phone" pattern="^\d{10}$" value="" required>
                        </div>
                        <div class="col-md-6">
                            <label>Alternate Phone Number</label>
                            <input type="tel" class="form-control" name="alternate_phone" pattern="^\d{10}$" value="">
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_city" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Woreda <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="woreda" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="long" id="pac-role" type="hidden">
...
<script>
    $(function() {
        ...
        $('.profileedit').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('mddoctor.register.submit.admin') }}",
                type: "post",
                data: fd,
                dataType: "JSON",
                processData: false,
