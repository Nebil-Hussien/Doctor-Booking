...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <a href=" {{route('mddoctor.profile.admin', base64_encode($serviceDetail->doctor_id))}} " class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a>
                    ...
                    <div class="row form-row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-select form-control" name="service_type" required>
                                    ...
                                    <option value="{{ $Type->id }}" @if($serviceDetail->service_id ==$Type->id) selected @endif>{{ $Type->service }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="specialization" class="form-control" value="{{$serviceDetail->specialization}}">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        $('.profileedit').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('mddoctor.service.update.register.admin') }}",
                type: "post",
                data: fd,
                dataType: "JSON",
                processData: false,
