...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <a href=" {{route('mddoctor.profile.admin', base64_encode($educationDetail->doctor_id))}} " class="btn btn-default pull-right"><i class="fa fa-angle-left"></i>Back</a>
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="field_study" value="{{ $educationDetail->field_of_study }}">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Graduated From</label>
                                <input type="text" name="graduated_from" class="form-control" value="{{ $educationDetail->graduated_from }}">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Year of Completion</label>
                                <input type="number" size="4" class="form-control" name="year_completion" value="{{ $educationDetail->year_of_completion }}">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <div class="profile-img" id="displaychange">
                                    <img src="{{asset($educationDetail->college_documnet)}}" alt="User Image">
                                </div>
                                <div class="upload-img">
                                    <div class="change-photo-btn">
                                        <span><i class="fa fa-upload"></i> Upload College Document</span>
                                        <input type="file" class="upload" name="collegeDocument" id="editDocument">
                                    </div>
...
<script>
    $(function() {
        ...
        $('#editDocument').on('change', function(e) {
        ...
        $('.profileedit').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('mddoctor.register.education.update.admin') }}",
                type: "post",
                data: fd,
                dataType: "JSON",
                processData: false,
