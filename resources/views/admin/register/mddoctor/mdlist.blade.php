      ...
      <div class="page-header">
         <div class="row justify-content-between ">
            ...
            <!-- <div class="col-xl-2 col-lg-2 col-sm-12 text-center">
               <a href="{{route('mddoctor.register.admin')}}" class="btn w-100 btn-outline-primary">Add New Doctor</a>
            </div> -->
         </div>
      </div>
...
<script>
   $(function() {
      ...
      $('body').on('click', '.status_item', function() {
         ...
         $.ajax({
            type: 'POST',
            url: "{{ route('mddoctor.status.admin') }}",
            data: fd,
            cache: false,
            contentType: false,
            processData: false,
      ...
      $('body').on('click', '.delete_item', function() {
         ...
         $.ajax({
            type: 'POST',
            url: "{{ route('mddoctor.delete.admin') }}",
            data: fd,
            cache: false,
            contentType: false,
            processData: false,
