                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="year_experience" value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Reference Name</label>
                                <input type="number" class="form-control" name="reference_name" value="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Reference Phone</label>
                                <input type="tel" class="form-control" name="reference_phone" pattern="^\d{10}$" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
