...
namespace App\Http\Controllers\Admin\ApprovalController\UserDoctor;
...
class ApprovalUserController extends Controller
{
    ...
    {
        return view('admin.register.userlist.userlist');
    }
    ...
    public function userpanelaccess(Request $request)
    {
        ...
        if (Auth::guard('user')->loginUsingId(['id' => $uniqueId])) {
            //  MyHelper::addToActivities('user login -' . Auth::guard('webadmin')->user()->id, Auth::guard('webadmin')->user()->id, 'WEBADMIN');
    ...
    public function delete(Request $request)
    {
        ...
        if ($updatedata) {
            //  MyHelper::addToActivities('hotel status update -' . Auth::guard('admin')->user()->id, Auth::guard('admin')->user()->id, 'ADMIN');
